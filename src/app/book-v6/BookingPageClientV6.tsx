...
interface BookingPageClientV6Props {
  tour: Tour;
...
export function BookingPageClientV6({ tour, companyName, paypalClientId, paypalMode }: BookingPageClientV6Props) {
  ...
  return (
    <div className="booking-page">
      ...
      <main className="booking-container">
        <div style={{ background: "rgba(200, 169, 110, 0.1)", border: "1px solid var(--gold)", padding: "0.75rem 1rem", marginBottom: "1.5rem", borderRadius: "6px", fontSize: "0.9rem" }}>
          <strong>SDK v6 Test Route</strong> — This page uses PayPal SDK v6 with Apple Pay + Google Pay support.
        </div>
