# Migration 017: Run in Supabase SQL Editor

**URL:** https://supabase.com/dashboard/project/yxqhxmurckdjiulfdvpc/sql/new
...
1. Verify table exists: `SELECT COUNT(*) FROM reservations;` (should return 0)
2. Verify columns added: `SELECT column_name FROM information_schema.columns WHERE table_name = 'bookings' AND column_name IN ('channel', 'channel_booking_reference', 'reservation_id');`
3. Set VIATOR_API_KEY when available: `echo "key" | npx wrangler secret put VIATOR_API_KEY`
